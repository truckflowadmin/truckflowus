  ...
  for (const t of tickets) {
    ...
    await prisma.ticket.create({
      data: {
        ...
        scannedTons: t.scannedTons != null ? String(t.scannedTons) : null,
        scannedYards: t.scannedYards != null ? String(t.scannedYards) : null,
        scannedTicketNumber: t.scannedTicketNumber != null ? String(t.scannedTicketNumber) : null,
        scannedDate: t.scannedDate != null ? String(t.scannedDate) : null,
        scannedRawText: t.scannedRawText != null ? String(t.scannedRawText) : null,
        scannedAt: new Date(),
      },
    });
